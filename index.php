...
$items_to_shop = get_items_to_shop($member_id);
  ...
  <nav class="navbar navbar-light bg-light px-4">
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center">
            <img src="path-to-logo/logo.png" alt="Logo" style="height: 40px; margin-right: 10px;">
        ...
        <div class="d-flex">
            ...
            <button class="btn btn-outline-primary mx-1" data-bs-toggle="modal" data-bs-target="#myItemsModal">My Items</button>
            <div class="dropdown">
            ...
            <a href="cart.php" class="btn btn-outline-secondary mx-1">
      ...
      <div 
        ...
        <div class="product-info d-flex justify-content-between align-items-center">
          ...
          <form method="post" class="d-inline">
            ...
            <?php 
              $seller_info = get_member_details_by_id($item['member_id']); 
            ?>
